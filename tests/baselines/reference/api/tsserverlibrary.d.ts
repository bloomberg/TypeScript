...
declare namespace ts {
    ...
    interface PrivateName extends Declaration {
...
declare namespace ts {
    ...
    function createPropertyAccess(expression: Expression, name: string | Identifier | PrivateName | undefined): PropertyAccessExpression;
