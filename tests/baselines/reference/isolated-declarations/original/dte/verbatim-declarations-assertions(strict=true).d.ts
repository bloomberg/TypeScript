...
export declare function fnWithRequiredDefaultParam(p: P, req: number): invalid;
export declare class C {
    ...
    readonly roFiled: P;
    method(p?: P): invalid;
    methodWithRequiredDefault(p: P, req: number): invalid;
...
==== assertToTypeReferences.ts (4 errors) ====
    type P = { } & { name: string }
...
==== assertToTypeLiteral.ts (6 errors) ====
    export let vLet = null! as {} & { name: string }
    export const vConst = null! as {} & { name: string }
...
==== angularAssertionToTypeReferences.ts (5 errors) ====
    type P = { } & { name: string }
