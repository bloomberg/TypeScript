import { AccessorDeclaration, ArrayBindingElement, AssertClause, BindingElement, BindingName, BindingPattern, Bundle, CallSignatureDeclaration, canHaveModifiers, ClassDeclaration, CommentRange, ConditionalTypeNode, ConstructorDeclaration, ConstructorTypeNode, ConstructSignatureDeclaration, createUnparsedSourceFile, Declaration, DeclarationName, DiagnosticWithLocation, EmitFlags, EntityNameOrEntityNameExpression, EnumDeclaration, ExportAssignment, ExportDeclaration, ExpressionWithTypeArguments, factory, FileReference, FunctionDeclaration, FunctionTypeNode, GeneratedIdentifierFlags, GetAccessorDeclaration, getCommentRange, getLeadingCommentRanges, getLineAndCharacterOfPosition, getNameOfDeclaration, getParseTreeNode, getTrailingCommentRanges, HasModifiers, HeritageClause, Identifier, ImportDeclaration, ImportEqualsDeclaration, ImportTypeNode, IndexSignatureDeclaration, InterfaceDeclaration, isArrayBindingElement, isBindingElement, isClassDeclaration, isClassElement, isEntityName, isExportAssignment, isExportDeclaration, isExpressionWithTypeArguments, isExternalModule, isExternalModuleReference, isFunctionDeclaration, isFunctionLike, isIdentifier, isImportDeclaration, isImportEqualsDeclaration, isIndexSignatureDeclaration, isInterfaceDeclaration, isLiteralExpression, isMappedTypeNode, isMethodDeclaration, isMethodSignature, isModifier, isModuleDeclaration, isOmittedExpression, isPrivateIdentifier, isPropertyAccessExpression, isPropertySignature, isSemicolonClassElement, isSetAccessorDeclaration, isSourceFile, isStatement, isStringLiteral, isStringLiteralLike, isTupleTypeNode, isTypeAliasDeclaration, isTypeElement, isTypeNode, isTypeParameterDeclaration, isTypeQueryNode, isUnparsedSource, isVariableDeclaration, MethodDeclaration, MethodSignature, Modifier, ModifierFlags, ModuleBody, ModuleDeclaration, NamedDeclaration, NamespaceDeclaration, Node, NodeArray, NodeBuilderFlags, NodeFactory,NodeFlags, OmittedExpression, ParameterDeclaration, PropertyDeclaration, PropertySignature, SetAccessorDeclaration, setCommentRange, setEmitFlags, setOriginalNode, setTextRange, SignatureDeclaration, SourceFile, Statement, StringLiteral, Symbol, SymbolFlags, SyntaxKind, TypeAliasDeclaration, TypeNode, TypeParameterDeclaration, TypeReferenceNode, unescapeLeadingUnderscores, UnparsedSource, VariableDeclaration, VariableStatement, visitEachChild, visitNode, visitNodes, VisitResult } from "typescript";

import { Debug } from "./debug";
import { Diagnostics } from "./diagnosticInformationMap.generated";
import { append, arrayFrom, compact, concatenate, contains, emptyArray, filter, flatMap, flatten, forEach, isArray, last, length, map, mapDefined, orderedRemoveItem, pushIfUnique, some, startsWith, stringContains, tryCast } from "./lang-utils";
...
import { addRelatedInfo, AllAccessorDeclarations, AnyImportSyntax, canProduceDiagnostics, createDiagnosticForNode, createEmptyExports, createGetSymbolAccessibilityDiagnosticForNode, createGetSymbolAccessibilityDiagnosticForNodeName, DeclarationDiagnosticProducing, declarationNameToString, getEffectiveBaseTypeNode, getEffectiveModifierFlags, getExternalModuleImportEqualsDeclarationExpression, getExternalModuleNameFromDeclaration, getFirstConstructorWithBody, getLeadingCommentRangesOfNode, getOriginalNodeId, getOutputPathsFor, getResolutionModeOverrideForClause, getResolvedExternalModuleName, getSetAccessorValueParameter, getSourceFileOfNode, getTextOfNode, getThisParameter, hasDynamicName, hasEffectiveModifier, hasIdentifierComputedName, hasJSDocNodes, hasSyntacticModifier, isAnyImportSyntax, isBindingPattern, isDeclaration, isEntityNameExpression, isExternalModuleAugmentation, isExternalModuleIndicator, isExternalOrCommonJsModule, isGlobalScopeAugmentation, isIdentifierANonContextualKeyword,isJsonSourceFile, isLateVisibilityPaintedStatement, isLiteralImportTypeNode, isNightly, isSourceFileJS, isSourceFileNotJson, LateVisibilityPaintedStatement, needsScopeMarker, pathContainsNodeModules, removeAllComments, setParent, skipTrivia, visitArray,  } from "./utils";
