...
// ==================
// Original test file: tsc-tests/updated-tests/conformance/types/conditional/conditionalTypes1.ts
// // @strict: true
// // @declaration: true
// 
...
// }
// 
// function f4<T extends { x: string | undefined }>(x: T["x"], y: NonNullable<T["x"]>): void {
//     x = y;
//     y = x;  // Error
//     let s1: string = x;  // Error
//     let s2: string = y;
