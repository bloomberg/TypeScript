...
declare function c9t5(f: (n: number) => IFoo): void;
...
// ==================
// Original test file: tsc-tests/updated-tests/compiler/contextualTyping.ts
// // @sourcemap: true
// // DEFAULT INTERFACES
// interface IFoo {
//     n: number;
...
// function c9t5(f: (n: number) => IFoo): void {};
// c9t5(function(n) {
//     return <IFoo>({});
// });
// 
...
// var i: C11t5 = new C11t5(function(n) { return <IFoo>({}) });
// 
