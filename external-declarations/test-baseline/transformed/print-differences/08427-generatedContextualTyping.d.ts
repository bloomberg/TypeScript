...
declare var b: Base, d1: Derived1, d2: Derived2;
declare var x1: () => Base[];
declare var x2: () => Base[];
declare var x3: () => Base[];
declare var x4: {
...
declare function x121(parm?: () => Base[]): void;
declare function x122(parm?: () => Base[]): void;
declare function x123(parm?: () => Base[]): void;
...
declare function x127(parm?: Base[]): void;
declare function x128(parm?: Array<Base>): void;
...
declare function x131(parm?: (s: Base[]) => any): void;
declare function x132(parm?: Genric<Base>): void;
...
declare var x217: () => Base[];
declare var x218: () => Base[];
declare var x219: () => Base[];
declare var x220: () => Base[];
declare var x221: Base[];
declare var x222: Base[];
declare var x223: {
    [n: number]: Base;
};
declare var x224: {
...
declare function x321(n: () => Base[]): void;
declare function x322(n: () => Base[]): void;
declare function x323(n: () => Base[]): void;
...
declare function x327(n: Base[]): void;
declare function x328(n: Array<Base>): void;
...
declare function x331(n: (s: Base[]) => any): void;
declare function x332(n: Genric<Base>): void;
declare var x333: (n: () => Base[]) => () => Base[];
declare var x334: (n: () => Base[]) => () => Base[];
declare var x335: (n: () => Base[]) => () => Base[];
declare var x336: (n: {
    (): Base[];
}) => () => Base[];
declare var x337: (n: {
...
declare var x339: (n: Base[]) => Base[];
declare var x340: (n: Array<Base>) => Base[];
declare var x341: (n: {
    [n: number]: Base;
}) => {
    [n: number]: Base;
...
declare var x343: (n: (s: Base[]) => any) => (s: Base[]) => any;
declare var x344: (n: Genric<Base>) => Genric<Base>;
declare var x345: (n: () => Base[]) => void;
declare var x346: (n: () => Base[]) => void;
declare var x347: (n: () => Base[]) => void;
declare var x348: (n: {
    (): Base[];
}) => void;
declare var x349: (n: {
...
declare var x351: (n: Base[]) => void;
declare var x352: (n: Array<Base>) => void;
declare var x353: (n: {
    [n: number]: Base;
}) => void;
declare var x354: (n: {
...
declare var x355: (n: (s: Base[]) => any) => void;
declare var x356: (n: Genric<Base>) => void;

// ==================
// Original test file: tsc-tests/updated-tests/conformance/expressions/contextualTyping/generatedContextualTyping.ts
...
// var b: Base = new Base(), d1: Derived1 = new Derived1(), d2: Derived2 = new Derived2();
// var x1: () => Base[] = () => [d1, d2];
...
// function x121(parm: () => Base[] = () => [d1, d2]): void { }
// function x122(parm: () => Base[] = function() { return [d1, d2] }): void { }
// function x123(parm: () => Base[] = function named() { return [d1, d2] }): void { }
// function x124(parm: { (): Base[]; } = () => [d1, d2]): void { }
// function x125(parm: { (): Base[]; } = function() { return [d1, d2] }): void { }
// function x126(parm: { (): Base[]; } = function named() { return [d1, d2] }): void { }
// function x127(parm: Base[] = [d1, d2]): void { }
// function x128(parm: Array<Base> = [d1, d2]): void { }
// function x129(parm: { [n: number]: Base; } = [d1, d2]): void { }
// function x130(parm: {n: Base[]; }  = { n: [d1, d2] }): void { }
// function x131(parm: (s: Base[]) => any = n => { var n: Base[]; return null; }): void { }
// function x132(parm: Genric<Base> = { func: n => { return [d1, d2]; } }): void { }
...
// var x217: () => Base[] = (<() => Base[]>undefined) || function() { return [d1, d2] };
// var x218: () => Base[] = (<() => Base[]>undefined) || function named() { return [d1, d2] };
// var x219: () => Base[] = (<{ (): Base[]; }>undefined) || function() { return [d1, d2] };
// var x220: () => Base[] = (<{ (): Base[]; }>undefined) || function named() { return [d1, d2] };
// var x221: Base[] = (<Base[]>undefined) || [d1, d2];
// var x222: Base[] = (<Array<Base>>undefined) || [d1, d2];
// var x223: {
//     [n: number]: Base;
// } = (<{ [n: number]: Base; }>undefined) || [d1, d2];
// var x224: {
//     n: Base[];
// } = (<{n: Base[]; } >undefined) || { n: [d1, d2] };
...
// function x321(n: () => Base[]): void { }; x321(() => [d1, d2]);
// function x322(n: () => Base[]): void { }; x322(function() { return [d1, d2] });
// function x323(n: () => Base[]): void { }; x323(function named() { return [d1, d2] });
// function x324(n: { (): Base[]; }): void { }; x324(() => [d1, d2]);
// function x325(n: { (): Base[]; }): void { }; x325(function() { return [d1, d2] });
// function x326(n: { (): Base[]; }): void { }; x326(function named() { return [d1, d2] });
// function x327(n: Base[]): void { }; x327([d1, d2]);
// function x328(n: Array<Base>): void { }; x328([d1, d2]);
// function x329(n: { [n: number]: Base; }): void { }; x329([d1, d2]);
// function x330(n: {n: Base[]; } ): void { }; x330({ n: [d1, d2] });
// function x331(n: (s: Base[]) => any): void { }; x331(n => { var n: Base[]; return null; });
// function x332(n: Genric<Base>): void { }; x332({ func: n => { return [d1, d2]; } });
// var x333 = (n: () => Base[]): () => Base[] => n; x333(() => [d1, d2]);
// var x334 = (n: () => Base[]): () => Base[] => n; x334(function() { return [d1, d2] });
// var x335 = (n: () => Base[]): () => Base[] => n; x335(function named() { return [d1, d2] });
// var x336 = (n: { (): Base[]; }): () => Base[] => n; x336(() => [d1, d2]);
// var x337 = (n: { (): Base[]; }): () => Base[] => n; x337(function() { return [d1, d2] });
// var x338 = (n: { (): Base[]; }): () => Base[] => n; x338(function named() { return [d1, d2] });
// var x339 = (n: Base[]): Base[] => n; x339([d1, d2]);
// var x340 = (n: Array<Base>): Base[] => n; x340([d1, d2]);
// var x341 = (n: { [n: number]: Base; }): {
//     [n: number]: Base;
// } => n; x341([d1, d2]);
// var x342 = (n: {n: Base[]; } ): {
//     n: Base[];
// } => n; x342({ n: [d1, d2] });
// var x343 = (n: (s: Base[]) => any): (s: Base[]) => any => n; x343(n => { var n: Base[]; return null; });
// var x344 = (n: Genric<Base>): Genric<Base> => n; x344({ func: n => { return [d1, d2]; } });
// var x345 = function(n: () => Base[]): void { }; x345(() => [d1, d2]);
// var x346 = function(n: () => Base[]): void { }; x346(function() { return [d1, d2] });
// var x347 = function(n: () => Base[]): void { }; x347(function named() { return [d1, d2] });
// var x348 = function(n: { (): Base[]; }): void { }; x348(() => [d1, d2]);
// var x349 = function(n: { (): Base[]; }): void { }; x349(function() { return [d1, d2] });
// var x350 = function(n: { (): Base[]; }): void { }; x350(function named() { return [d1, d2] });
// var x351 = function(n: Base[]): void { }; x351([d1, d2]);
// var x352 = function(n: Array<Base>): void { }; x352([d1, d2]);
// var x353 = function(n: { [n: number]: Base; }): void { }; x353([d1, d2]);
// var x354 = function(n: {n: Base[]; } ): void { }; x354({ n: [d1, d2] });
// var x355 = function(n: (s: Base[]) => any): void { }; x355(n => { var n: Base[]; return null; });
// var x356 = function(n: Genric<Base>): void { }; x356({ func: n => { return [d1, d2]; } });