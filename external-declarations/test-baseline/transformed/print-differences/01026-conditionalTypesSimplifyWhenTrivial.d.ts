...
declare const fn5: <Params>(params: Pick<Params, ExcludeWithDefault<keyof Params, never>>) => Params;
declare function fn6<T>(x: ExcludeWithDefault<T, never>): void;
declare const fn7: <Params>(params: Pick<Params, ExtractWithDefault<keyof Params, keyof Params>>) => Params;
