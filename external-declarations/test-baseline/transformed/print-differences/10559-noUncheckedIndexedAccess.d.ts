...
declare enum StringEnum1 {
    A = "Alpha",
    B = "Beta"
}
declare const strMap: {
    [s: string]: boolean;
};
declare const e1: boolean;
declare const e2: boolean;
declare const e3: boolean;
declare const e4: boolean;
declare const e5: boolean;
declare const e6: boolean;
declare const e7: boolean;
declare const e8: boolean;
declare const e9: boolean;
declare const e10: boolean;
declare const e11: boolean;
declare const e12: boolean;
declare const e13: boolean;
declare const e14: boolean;
declare const ok1: boolean | undefined;
declare const ok2: boolean | undefined;
...
declare const numMap: {
    [s: number]: boolean;
};
declare const num_ok1: boolean;
declare const num_ok2: boolean;
declare const num_ok3: boolean;
declare const num_ok4: boolean;
declare const num_ok5: boolean;
declare function generic1<T extends {
    [s: string]: boolean;
}>(arg: T): boolean;
declare function generic2<T extends {
    [s: string]: boolean;
}>(arg: T): boolean;
declare function generic3<T extends string>(arg: T): boolean;
declare const obj1: {
    x: string;
    y: number;
...
declare const y = "y";
declare let yy: string;
declare let z: string;
declare const strMapUnion: {
    [s: string]: boolean;
} | {
    [s: string]: number;
};
declare const f1: boolean | number;
declare const s: unique symbol;
declare const symbolMap: {
    [s]: string;
};
declare const e15: string;
declare const nonEmptyStringArray: [string, ...string[]];
declare const variadicOk1: string;
declare const variadicError1: string;
declare const myRecord1: {
    a: string;
    b: string;
};
declare const myRecord2: {
    a: string;
    b: string;
    [key: string]: string;
};
...
// const fn3 = <Key extends keyof typeof myRecord2>(key: Key): void => {
