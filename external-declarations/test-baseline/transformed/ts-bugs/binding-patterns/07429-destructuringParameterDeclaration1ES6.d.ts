// destructuringParameterDeclaration1ES6.d.ts
...
declare function e6({ x: [number, number, number] }: {
    x: [any, any, any];
}): void;

// ==================
// Original test file: tsc-tests/updated-tests/conformance/es6/destructuring/destructuringParameterDeclaration1ES6.ts
...
//         x: [any, any, any];
//     }): void { }  // error, duplicate identifier;
// 
// 
// 