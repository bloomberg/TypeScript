// sourceMapValidationDestructuringParameterNestedObjectBindingPattern.d.ts
declare var console: {
    log(msg: string): void;
};
interface Robot {
...
// ==================
// Original test file: tsc-tests/updated-tests/compiler/sourceMapValidationDestructuringParameterNestedObjectBindingPattern.ts
// // @lib: es5
// // @sourcemap: true
// declare var console: {
//     log(msg: string): void;
...
// 
// function foo1({ skills: { primary: primaryA, secondary: secondaryA } }: Robot): void {
//     console.log(primaryA);
// }
// function foo2({ name: nameC, skills: { primary: primaryB, secondary: secondaryB } }: Robot): void {
//     console.log(secondaryB);
// }
// function foo3({ skills }: Robot): void {
