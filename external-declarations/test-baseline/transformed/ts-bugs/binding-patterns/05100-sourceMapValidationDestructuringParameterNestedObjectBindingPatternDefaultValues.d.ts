// sourceMapValidationDestructuringParameterNestedObjectBindingPatternDefaultValues.d.ts
declare var console: {
    log(msg: string): void;
};
interface Robot {
...
// ==================
// Original test file: tsc-tests/updated-tests/compiler/sourceMapValidationDestructuringParameterNestedObjectBindingPatternDefaultValues.ts
// // @lib: es5
// // @sourcemap: true
// declare var console: {
//     log(msg: string): void;
...
// }
// function foo3({ skills = { primary: "SomeSkill", secondary: "someSkill" }  }: Robot = robotA): void {
