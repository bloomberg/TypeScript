...
/** @internal */
export function getPropertyNameForPropertyNameNode(name: Exclude<PropertyName, ComputedPropertyName> | JsxAttributeName): __String;
/** @internal */
...
/** @internal */
export function getAnyImportSyntax(node: Node): AnyImportOrJsDocImport | undefined {
    switch (node.kind) {
        case SyntaxKind.ImportEqualsDeclaration:
...
export function createNameResolver(
    ...
    extendedResolveErrorReporting: (
        result: Symbol | undefined,
        originalLocation: Node | undefined,
        name: __String,
        meaning: SymbolFlags,
        nameNotFoundMessage: DiagnosticMessage | undefined,
        nameArg: __String | Identifier | undefined,
        ...
        propertyWithInvalidInitializer: PropertyDeclaration | undefined,
    ...
    function resolveNameHelper(
        ...
        return extendedResolveErrorReporting(
            result,
            originalLocation,
            name,
            meaning,
